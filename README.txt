...
The archive trial_run contains files which are intended to be a demonstration.  Please use the example provided to test your R setup. 
This folder is self-contained, and the whole process of set selection, pre-processing and classification can be done in the same directory.
Please extract this to a folder of your choice on your computer.
